...
//            if (roleManager == null)
//            {
//                throw new InvalidOperationException("RoleManager service not available");
//            }
...
//            var janeUser = await userManager.FindByNameAsync("jane_smith");
//            var janeAlumni = await context.Alumni.FirstOrDefaultAsync(a => a.JagId == "J0012346");
//            if (janeUser != null && janeAlumni != null)
//            {
//                janeAlumni.UserId = janeUser.Id;
//                context.Alumni.Update(janeAlumni);
//                await context.SaveChangesAsync();
//            }

//            var michaelUser = await userManager.FindByNameAsync("michael.j");
//            var michaelAlumni = await context.Alumni.FirstOrDefaultAsync(a => a.JagId == "J0012347");
//            if (michaelUser != null && michaelAlumni != null)
//            {
//                michaelAlumni.UserId = michaelUser.Id;
//                context.Alumni.Update(michaelAlumni);
//                await context.SaveChangesAsync();
//            }
//        }
//    }
